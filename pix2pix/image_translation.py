...
# dataset load
[X1, X2] = load_real_samples('pix2pix/data/real2sketch.npz')
print('Loaded', X1.shape, X2.shape)
# model load
model = load_model('pix2pix/model/model_045500.h5')
# random example 선택
...
print(model.compute_metrics(src_image, tar_image, gen_image, 0.5))